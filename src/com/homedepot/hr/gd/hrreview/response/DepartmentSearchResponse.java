...
@XStreamAlias("DepartmentSearch")
public class DepartmentSearchResponse
{
	private boolean sucess;
	private String message;
	private List<DepartmentSearchDTO> departmentSearchDTO;
	...
	public List<DepartmentSearchDTO> getDepartmentSearchDTO() {
		return departmentSearchDTO;
	}
	public void setDepartmentSearchDTO(List<DepartmentSearchDTO> departmentSearchDTO) {
